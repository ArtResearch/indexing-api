...
public class PhotographersIndexGenerator {
    ...
    public void indexResources(String core_name) {
        ...
        Utils.merge(Resources.FOLDER_OUTPUT_INDEXING_PHOTOGRAPHERS_JSON, Resources.FOLDER_OUTPUT_INDEXING_PHOTOGRAPHERS_JSON);
        
        Utils.split(Resources.FOLDER_OUTPUT_INDEXING_PHOTOGRAPHERS_JSON);
        Utils.updateSolrIndex(Resources.TYPE_PHOTOGRAPHERS,Resources.FOLDER_OUTPUT_INDEXING_PHOTOGRAPHERS_JSON, Resources.SOLR_CORE);
        Utils.updateSolrIndex(Resources.TYPE_PHOTOGRAPHERS, Resources.FOLDER_OUTPUT_INDEXING_PHOTOGRAPHERS_JSON, Resources.SOLR_CORE);
        Utils.updateSolrIndex(Resources.TYPE_PHOTOGRAPHERS, Resources.FOLDER_OUTPUT_INDEXING_PHOTOGRAPHERS_JSON, Resources.SOLR_CORE);
